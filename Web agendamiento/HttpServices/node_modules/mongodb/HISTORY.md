...
* NODE-985 Deprecated Db.authenticate and Admin.authenticate and moved auth methods into authenticated.js to ensure MongoClient.connect does not print deprecation warnings.
